...
class Master(UserCount : Int, system: ActorSystem) extends Actor 
{
      ...
      case START() =>
      {
        ...
        {
          import system.dispatcher
            system.scheduler.schedule(0 milliseconds,120000 milliseconds,ClientActor(cores-1),HashedTweet(i))
        }
         
        import system.dispatcher
          system.scheduler.schedule(0 milliseconds,180000 milliseconds, ClientActor(cores-1), Retrieve(UserCount))  
         
        import system.dispatcher
          system.scheduler.schedule(0 milliseconds,200000 milliseconds, ClientActor(cores-1), Retrieve_Self(UserCount))          
          
        import system.dispatcher
          system.scheduler.schedule(0 milliseconds,90000 milliseconds, ClientActor(cores-1), follow(UserCount))          
       
       import system.dispatcher
          system.scheduler.schedule(0 milliseconds,75000 milliseconds, ClientActor(cores-1), ReTweet(UserCount))          
